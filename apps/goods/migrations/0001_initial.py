# Generated by Django 2.2.16 on 2020-11-26 09:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_brief', models.TextField(max_length=100, verbose_name='商品简短描述')),
                ('goods_desc', DjangoUeditor.models.UEditorField(default='', verbose_name='课程详情')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_type', models.IntegerField(choices=[(1, '一级类目'), (2, '二级类目'), (3, '三级类目')], help_text='类别级别', verbose_name='类别目录')),
