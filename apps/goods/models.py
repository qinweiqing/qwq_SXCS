...
class GoodsCategory(models.Model):
    ...
    # 目录树级别
    category_type=models.IntegerField('类别目录',choices=CATEGORY_TYPE,help_text='类别级别')
    # 设置models有一个指向自己的外键
    parent_category=models.ForeignKey('self',on_delete=models.CASCADE,null=True,blank=True,verbose_name='父级目录',help_text='父级目录',related_name='sub_cat')
...
class Goods(models.Model):
    ...
    goods_brief=models.TextField('商品简短描述',max_length=100)
    goods_desc=UEditorField(verbose_name='内容',width=1000,height=300,imagePath='goods/images',
